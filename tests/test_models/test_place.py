...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_verify_new_instance_stored_in_objects(self):
    ...
    def test_verify_city_id_is_class_attribute(self):
        pl = Place()
    ...
    def test_verify_description_is_class_attribute(self):
        pl = Place()
    ...
    def test_two_places_has_unique_ids(self):
        pl1 = Place()
        pl2 = Place()
        self.assertNotEqual(pl1.id, pl2.id)

    def test_two_places_created_at_is_not_same(self):
        pl1 = Place()
        sleep(1)
        pl2 = Place()
        self.assertLess(pl1.created_at, pl2.created_at)

    def test_two_places_updated_at_is_not_same(self):
        pl1 = Place()
        sleep(1)
        pl2 = Place()
    ...
    def test_args_that_were_unused(self):
        pl = Place(None)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_at_datetime_and_attributes_are_strs(self):
        pl = Place()
        pl_dict = pl.to_dict()
